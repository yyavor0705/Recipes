...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_partial_update(self):
        recipe = sample_recipe(self.user)
        recipe.tags.add(sample_tag(self.user))
        new_tag = sample_tag(self.user, "tag 123")
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        tag2 = sample_tag(user=self.user, name='Another tag')
    ...
    def test_recipes_filtering_by_ingredients(self):
        recipe1 = sample_recipe(user=self.user, title='Recipe1')
        recipe2 = sample_recipe(user=self.user, title="Recipe2")
        ingredient1 = sample_ingredient(user=self.user, name='Ingredient one')
        ingredient2 = sample_ingredient(user=self.user, name='Another ingredient')
